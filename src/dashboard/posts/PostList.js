...
const PostList = ({user, postList}) => {
  ...
  return (
    <div className='max-w-[1440px] mx-auto  py-12 px-12 md:py-6 md:px-12 sm:py-4 sm:px-2'>
       <Link to="/create_post" href=""  className='text-center border py-1 px-1 text-md md:px-4 md:py-4 sm:px-2 sm:py-2 md:text-lg  bg-blue-600 rounded-lg text-white disabled:opacity-50' disabled={user == null}>
          List your business
          </Link>
